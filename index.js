import{a as q,i as I,S as se}from"./assets/vendor-CYE3kvfv.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();const p={headerBtnOpenMenu:document.querySelector(".header-button-menu"),headerBtnCloseMenu:document.querySelector(".button-close"),mobileMenu:document.querySelector(".menu-drive")},F=()=>{p.mobileMenu.classList.toggle("is-open"),document.body.classList.toggle("no-scroll")};p.headerBtnOpenMenu&&p.mobileMenu&&p.headerBtnOpenMenu.addEventListener("click",F);p.headerBtnCloseMenu&&p.mobileMenu&&p.headerBtnCloseMenu.addEventListener("click",F);function re(e){const s=Math.floor(e/1e3),t=Math.floor(s/60),r=s%60;return`${t}:${r.toString().padStart(2,"0")}`}function oe(e,s){return!e&&!s?"Information missing":s?`${e} - ${s}`:`${e}-present`}function ne(){const e=document.querySelector(".loader");e&&(e.style.display="block")}function ie(){const e=document.querySelector(".loader");e&&(e.style.display="none")}function ae(e,s=250){e||(e="Information missing");const t=e.length>s,r=e.slice(0,s);return`
  ...
  `}function ce(e){const s=document.querySelector("#bio-toggle"),t=document.querySelector("#bio-text");if(!s)return;let r=!1;s.addEventListener("click",()=>{r=!r,r?(t.textContent=e,s.innerHTML=`
      ...
      `}).reduce((d,f,L,T)=>(L%2===0?d.push(`<div class="albums-thumb">${f}`):d[d.length-1]+=f+"</div>",L===T.length-1&&L%2===0&&(d[d.length-1]+="</div>"),d),[]).join("");y.innerHTML=`
  ...
  `,ce(c),le()}const Y=document.querySelector(".artists-list"),z=document.querySelector(".artists-loader"),U=document.querySelector(".artists-load-more-btn");function J(){z.classList.remove("is-hidden")}function K(){z.classList.add("is-hidden")}function fe(){U.classList.remove("is-hidden")}function A(){U.classList.add("is-hidden")}function P(){Y.innerHTML=""}function me(e){return!Array.isArray(e)||e.length===0?"":`<div class="artist-genres">${e.map(t=>`<span class="genre-tag">${t}</span>`).join("")}</div>`}function W(e){const s=e.map(t=>{const r=t.strBiographyEN||"";return`
            ...
            `}).join("");Y.insertAdjacentHTML("beforeend",s),document.addEventListener("click",t=>{if(t.target.classList.contains("learn-more-btn")){const r=t.target.dataset.artistId;ue(r)}})}const ge="https://sound-wave.b.goit.study",Q=8;async function he(e=1){const s={limit:Q,page:e};try{return(await q.get(`${ge}/api/artists`,{params:s})).data}catch(t){throw t}}const be=document.querySelector(".artists-load-more-btn");let O=1,H=0;async function ye(){J(),A();try{const e=await he(O),s=e.artists,t=e.totalArtists;if(H=Math.ceil(t/Q),W(s),s.length===0){I.error({title:"Поиск не дал результатов",message:"К сожалению, по вашему запросу артистов не найдено.",position:"topRight"});return}O<H?fe():A()}catch(e){I.error({title:"Ошибка",message:`Ошибка запроса: ${e.message}`,position:"topRight"}),A()}finally{K()}}be.addEventListener("click",async()=>{O+=1,await ye()});const X="https://sound-wave.b.goit.study",C=8;let m=1,Le=0,E="",w="",h="";function k(){return{filtersToggleBtn:document.querySelector(".filters-toggle-btn"),filtersPanel:document.querySelector(".filters-panel"),genreListMobile:document.querySelector(".genre-list"),sortListMobile:document.querySelector(".sort-list"),searchInput:document.getElementById("artist-search"),searchInputDesktop:document.getElementById("artist-search-desktop"),resetBtn:document.querySelectorAll(".reset-btn"),emptyState:document.querySelector(".empty-state"),resetFiltersBtn:document.querySelector(".reset-filters-btn"),sortOptionsDesktop:document.querySelector(".sort-options-desktop"),genreOptionsDesktop:document.querySelector(".genre-options-desktop"),filterAccordionHeaders:document.querySelectorAll(".filter-accordion-header"),filterGroupHeaders:document.querySelectorAll(".filter-group-header")}}async function ve(){try{const s=(await q.get(`${X}/api/genres`)).data;return Array.isArray(s)?s.map(t=>typeof t=="string"?t:typeof t=="object"&&t!==null&&(t.name||t.genre||t.title)||String(t)):typeof s=="object"&&s!==null?Object.values(s).map(t=>typeof t=="string"?t:typeof t=="object"&&t!==null&&(t.name||t.genre||t.title)||String(t)):[]}catch(e){return console.error("Error fetching genres:",e),[]}}async function Se(){const e=k(),s=await ve();e.genreOptionsDesktop&&(e.genreOptionsDesktop.innerHTML='<li class="filter-option-item active" data-genre="">All Genres</li>',s.forEach(t=>{const r=document.createElement("li");r.className="filter-option-item",r.textContent=t,r.setAttribute("data-genre",t),e.genreOptionsDesktop.appendChild(r)})),e.genreListMobile&&(e.genreListMobile.innerHTML='<li class="dropdown-item" data-genre="">All Genres</li>',s.forEach(t=>{const r=document.createElement("li");r.className="dropdown-item",r.textContent=t,r.setAttribute("data-genre",t),e.genreListMobile.appendChild(r)}))}function ke(){const e=k();if(e.sortListMobile){const s=e.sortListMobile.querySelector('.sort-item[data-sort=""]');s&&s.classList.add("active")}if(e.sortOptionsDesktop){const s=e.sortOptionsDesktop.querySelector('.filter-option-item[data-sort=""]');s&&s.classList.add("active")}}async function g(e=1){const s=k();s.emptyState&&s.emptyState.classList.add("is-hidden"),J(),A();const t={limit:C,page:e};E&&(t.genre=E);try{const i=(await q.get(`${X}/api/artists`,{params:t})).data;let a=i.artists||[];const l=i.totalArtists||0;if(h){const o=h.toLowerCase();a=a.filter(c=>(c.strArtist||"").toLowerCase().includes(o))}w&&a.length>0&&a.sort((o,c)=>{const u=(o.strArtist||"").toLowerCase(),y=(c.strArtist||"").toLowerCase();return w==="name_asc"?u.localeCompare(y):y.localeCompare(u)});const n=h?a.length:l;return Le=Math.ceil(n/C),m=e,P(),a.length===0&&e===1?s.emptyState&&s.emptyState.classList.remove("is-hidden"):W(a),{artists:a,totalArtists:n}}catch(r){return console.error("Error fetching artists:",r),P(),s.emptyState&&s.emptyState.classList.remove("is-hidden"),{artists:[],totalArtists:0}}finally{K()}}function j(){const e=k();if(E="",w="",h="",m=1,e.searchInput&&(e.searchInput.value=""),e.searchInputDesktop&&(e.searchInputDesktop.value=""),[e.sortListMobile,e.sortOptionsDesktop].forEach(s=>{if(!s)return;s.querySelectorAll(".sort-item, .filter-option-item").forEach(r=>{r.classList.remove("active")});const t=s.querySelector('[data-sort=""]');t&&t.classList.add("active")}),e.genreOptionsDesktop){e.genreOptionsDesktop.querySelectorAll(".filter-option-item").forEach(t=>{t.classList.remove("active")});const s=e.genreOptionsDesktop.querySelector('[data-genre=""]');s&&s.classList.add("active")}g(1)}function Me(){var i,a,l;const e=k();function s(n){E=n,e.genreOptionsDesktop&&e.genreOptionsDesktop.querySelectorAll(".filter-option-item").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-genre")===n)}),e.genreListMobile&&e.genreListMobile.querySelectorAll(".dropdown-item").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-genre")===n)}),m=1,g(1)}function t(n){w=n,e.sortOptionsDesktop&&e.sortOptionsDesktop.querySelectorAll(".filter-option-item").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-sort")===n)}),e.sortListMobile&&e.sortListMobile.querySelectorAll(".sort-item").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-sort")===n)}),m=1,g(1)}function r(n,o){if(!n)return;let c;n.addEventListener("input",()=>{clearTimeout(c),c=setTimeout(()=>{h=n.value.trim(),o&&(o.value=n.value),m=1,g(1)},500)}),n.addEventListener("keypress",u=>{u.key==="Enter"&&(clearTimeout(c),h=n.value.trim(),o&&(o.value=n.value),m=1,g(1))})}e.genreOptionsDesktop&&e.genreOptionsDesktop.addEventListener("click",n=>{const o=n.target.closest(".filter-option-item");o&&s(o.getAttribute("data-genre")||"")}),e.genreListMobile&&e.genreListMobile.addEventListener("click",n=>{const o=n.target.closest(".dropdown-item");o&&s(o.getAttribute("data-genre")||"")}),e.sortOptionsDesktop&&e.sortOptionsDesktop.addEventListener("click",n=>{const o=n.target.closest(".filter-option-item");o&&t(o.getAttribute("data-sort")||"")}),e.sortListMobile&&e.sortListMobile.addEventListener("click",n=>{const o=n.target.closest(".sort-item");o&&t(o.getAttribute("data-sort")||"")}),r(e.searchInput,e.searchInputDesktop),r(e.searchInputDesktop,e.searchInput),((i=e.resetBtn)==null?void 0:i.length)>0&&e.resetBtn.forEach(n=>n.addEventListener("click",j)),e.resetFiltersBtn&&e.resetFiltersBtn.addEventListener("click",j),e.filtersToggleBtn&&e.filtersPanel&&e.filtersToggleBtn.addEventListener("click",()=>{const n=e.filtersPanel.classList.contains("is-hidden");e.filtersPanel.classList.toggle("is-hidden",!n),e.filtersToggleBtn.classList.toggle("is-open",n)}),(a=e.filterGroupHeaders)==null||a.forEach(n=>{n.addEventListener("click",()=>{var c;const o=(c=n.closest(".filter-group"))==null?void 0:c.querySelector(".filter-group-content");o&&o.classList.toggle("is-hidden")})}),(l=e.filterAccordionHeaders)==null||l.forEach(n=>{n.addEventListener("click",()=>{var c;const o=(c=n.closest(".filter-accordion"))==null?void 0:c.querySelector(".filter-accordion-content");o&&o.classList.toggle("is-hidden")})})}async function Ae(){try{document.readyState==="loading"&&await new Promise(e=>document.addEventListener("DOMContentLoaded",e)),await new Promise(e=>setTimeout(e,300)),Me(),await Se(),ke(),await g(1)}catch(e){console.error("Error initializing filters:",e)}}Ae();const M=window.$,$=document.querySelector(".submit-modal"),b=document.querySelector(".submit-feedback"),Ee=document.querySelector(".submit-button_modal"),v=document.querySelector(".submit-form"),G="project-feedbacks";function we(){b&&b.classList.add("is-open"),$&&($.classList.add("is-open"),document.body.style.overflow="hidden")}function B(){b&&b.classList.remove("is-open"),$&&($.classList.remove("is-open"),document.body.style.overflow="")}Ee.addEventListener("click",B);b.addEventListener("click",e=>{e.target===b&&B()});M(document).ready(()=>{M("#user-rating-input").raty({starType:"img",number:5,path:"https://cdnjs.cloudflare.com/ajax/libs/raty/2.7.1/images",score:0,click:e=>{M("#rating-score").val(e)}}),v.addEventListener("submit",e=>{e.preventDefault();const s=v.username.value.trim(),t=v.message.value.trim(),r=Number(v["rating-score"].value);if(!s||!t||r===0){alert("Please, fill the fields and choose a rating");return}const i={id:Date.now().toString(),name:s,message:t,rating:r},a=JSON.parse(localStorage.getItem(G))||[];a.push(i),localStorage.setItem(G,JSON.stringify(a)),v.reset(),M("#user-rating-input").raty("score",0),document.querySelector("#rating-score").value=0,B()})});const $e="https://sound-wave.b.goit.study",qe=`${$e}/api/feedbacks`,R="project-feedbacks",S=document.querySelector(".swiper-wrapper"),x=document.querySelector(".feedback-submit-btn");function _({name:e,feedback:s,rating:t}){const r=Math.round(t);return`<div class="swiper-slide feedback-card">
